...
/*
   Now, let's create a test case where the `Garden` should be able to add other plants.
   Define the test case with the string `"should be able to add other plants"` and pass in an empty function.
*/